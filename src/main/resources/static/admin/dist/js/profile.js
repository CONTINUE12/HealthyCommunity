$(function () {
    //修改个人信息
    $('#updateAdminUserNameButton').click(function () {
        $("#updateAdminUserNameButton").attr("disabled",true);
            ...
            $.ajax({
                ...
                success: function (r) {
                    if (r == 'success') {
                        ...
                        alert('修改失败');
                        $("#updateAdminUserNameButton").prop("disabled",false);
                    }
                }
            });
        } else {
    ...
    //修改密码
    $('#updateAdminPasswordButton').click(function () {
        $("#updateAdminPasswordButton").attr("disabled",true);
            ...
            $.ajax({
                ...
                success: function (r) {
                    ...
                    if (r == 'success') {
                        ...
                        alert('修改失败');
                        $("#updateAdminPasswordButton").attr("disabled",false);
                    }
                }
            });
        } else {
